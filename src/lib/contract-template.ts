...
<p>${esc(operator)}، سجل تجاري رقم (${BLANK})، وعنوانها ${esc(address)}، المملكة العربية السعودية؛ ويُشار إليها فيما بعد بــ ("الطرف الثاني / المشغل").</p>

<h2 class="ct-h2">تمهيد — Preamble</h2>
<p>حيث تلاقت رغبة الطرفان في قيام الطرف الثاني بتشغيل مساحة محددة لأغراض تجارية وخدمية للفعالية التي يديرها الطرف الأول، أبرم الطرفان هذا العقد واتفقا على الآتي:</p>

<h2 class="ct-h2">القسم الأول: المعلومات العامة — General Information</h2>
<table class="ct-table">
  <tr><th>اسم المشروع / Project Name</th><td>${esc(projectName)}</td><th>الفعالية / Event</th><td>${esc(event)}</td></tr>
  <tr><th>موقع المشروع / Location</th><td>${esc(location)}</td><th>العلامة التجارية / Brand</th><td>${esc(brand)}</td></tr>
  <tr><th>النشاط التجاري / Activity</th><td>${esc(activity)}</td><th>المدة / Duration</th><td>${esc(durationText(req))}</td></tr>
  <tr><th>تاريخ البداية / Start</th><td>${esc(start)}</td><th>تاريخ النهاية / End</th><td>${esc(end)}</td></tr>
  <tr><th>المقابل المالي (غير شامل الضريبة) / Consideration (ex. VAT)</th><td colspan="3">${money}</td></tr>
  <tr><th>آلية الدفع / Payment</th><td colspan="3">يُسدد المقابل المالي فور توقيع العقد على الحساب البنكي المعتمد للطرف الأول، ولا يُسلّم الموقع إلا بعد السداد.</td></tr>
  <tr><th>حساب الطرف الأول / SELA Account</th><td colspan="3">المستفيد: شركة صلة — مصرف الراجحي (آيبان: ${BLANK})</td></tr>
</table>

<h2 class="ct-h2">ممثلو الطرفين — Representatives</h2>
<table class="ct-table">
  <tr><th>ممثل الطرف الأول / First Party Rep.</th><td>قسم تأجير مساحات الفعاليات — EventLeasing@sela.sa</td></tr>
  <tr><th>ممثل الطرف الثاني / Second Party Rep.</th><td>${esc(repName)} — ${esc(repEmail)} — ${esc(repPhone)}</td></tr>
</table>

<h2 class="ct-h2">القسم الثاني: الشروط والأحكام — Terms &amp; Conditions</h2>
<ol class="ct-terms">
  <li><b>مدة العقد:</b> يبدأ العمل بهذا العقد فور توقيعه ويظل سارياً طوال مدته، ويجوز للطرف الأول الإنهاء فوراً للإخلال الجوهري أو بإشعار لا تقل مدته عن خمسة (5) أيام. وترتبط المدة بفترة الفعالية.</li>
  <li><b>المقابل المالي وآلية الدفع:</b> يُسدد مقدماً خلال خمسة (5) أيام من المطالبة. وعند وجود نسبة مشاركة من المبيعات يلتزم الطرف الثاني بتقرير مبيعات يومي وتسوية الفروقات خلال عشرة (10) أيام.</li>
  <li><b>التزامات الطرف الأول:</b> تمكين المشغل من استلام الموقع وتوفير المياه والكهرباء خلال أوقات العمل، مع حقه في التعاقد مع أطراف آخرين لخدمات مماثلة.</li>
  <li><b>التزامات الطرف الثاني:</b> ممارسة النشاط وفق السجل التجاري، واتخاذ كافة إجراءات الأمن والسلامة والصحة العامة، وتحمل كافة التعويضات، وتوفير بوليصة تأمين شاملة (تسمم غذائي بحد أدنى مليون ريال، تأمين شامل للمساحة بحد أدنى خمسة ملايين ريال يكون الطرف الأول مؤمناً له إضافياً، وتأمين ضد الحريق حتى خمسة ملايين ريال)، وضمان جميع التراخيص والاشتراطات الصحية والبلدية.</li>
  <li><b>الأحكام العامة:</b> حسن النية، ومسؤولية الطرف الثاني عن عامليه، والالتزام بجدول الجزاءات، وأحكام القوة القاهرة (إشعار خلال 3 أيام)، والسرية لمدة خمس سنوات، والتعويض الكامل. يخضع العقد لأنظمة المملكة العربية السعودية، وتختص محاكم جدة بأي نزاع يتعذّر حله ودياً خلال ثلاثين (30) يوماً.</li>
</ol>

<h2 class="ct-h2">القسم الثالث: جدول مخالفات المشغلين — Penalties Schedule</h2>
<table class="ct-table ct-penalties">
  <tr><th>المخالفة / Violation</th><th>المرة الأولى</th><th>المرة الثانية</th><th>المرة الثالثة</th><th>المرة الرابعة</th></tr>
  <tr><td>مخالفات أوقات/أحكام التشغيل</td><td>إنذار كتابي</td><td>1,000 ريال</td><td>5,000 ريال</td><td>10,000 ريال</td></tr>
  <tr><td>النظافة والصحة العامة</td><td>إنذار كتابي</td><td>1,000 ريال</td><td>5,000 ريال</td><td>10,000 ريال</td></tr>
  <tr><td>مخالفات عامة</td><td>إنذار كتابي</td><td>1,000 ريال</td><td>5,000 ريال</td><td>10,000 ريال</td></tr>
</table>
<p class="ct-note">في حال كون المخالفة جوهرية أو تكرارها أكثر من (4) مرات يُفسخ العقد فوراً. جميع الجزاءات غير شاملة لضريبة القيمة المضافة.</p>

<h2 class="ct-h2">التوقيع — Signatures</h2>
<table class="ct-table ct-sign">
  <tr><th>الطرف الأول / First Party (SELA)</th><th>الطرف الثاني / Second Party</th></tr>
  <tr>
    <td>الاسم: عدنان كيال<br/>الصفة: المفوض بالتوقيع<br/>التاريخ: ${BLANK}<br/>التوقيع: ____________</td>
    <td>الاسم: ${esc(signatory)}<br/>الصفة: ${BLANK}<br/>التاريخ: ${BLANK}<br/>التوقيع: ____________</td>
  </tr>
</table>
`.trim();
